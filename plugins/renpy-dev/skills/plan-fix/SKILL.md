...
**文档查询：** 需要 Ren'Py API 语法时，读 `plugins/renpy-dev/references/renpy-docs.md` 获取约定，用 `WebFetch` 查 `https://www.renpy.org/doc/html/`。
...
## 概述
{根因描述 + 项目环境 + RENPY_SDK 状态 + game/tests/ 状态}
